...
\hypersetup{
  colorlinks = true,
  linkcolor  = fastprimary,
  urlcolor   = fastprimary,
  citecolor  = fastprimary
}

% Section heading formatting
\titleformat{\section}{\Large\bfseries\color{fastprimary}}{\thesection}{0.75em}{}
\titleformat{\subsection}{\large\bfseries\color{fastprimary}}{\thesubsection}{0.75em}{}
\titleformat{\subsubsection}{\normalsize\bfseries\color{fastprimary}}{\thesubsubsection}{0.75em}{}
